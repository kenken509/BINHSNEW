            ...
            <table  class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody v-for="post in allPost.posts" :key="post.id" >
                    <tr class="bg-white border-b ">
                        ...
                        <td>
                            <div class=" space-x-4">
                                <Link :href="route('webPost.delete', {id:post.id })" class="cursor-pointer" v-tooltip.left="'Delete Question'" as="button" method="delete" ><span class="pi pi-trash text-red-700 scale-110 hover:dark:scale-150"></span></Link>
